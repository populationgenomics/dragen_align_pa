...
patch it on `dragen_align_pa.constants.constants` (where the data lives) — the resolvers
...
def test_resolve_ica_file_id_returns_registered_id(monkeypatch):
    ...
    monkeypatch.setattr(
        'dragen_align_pa.constants.constants.ICA_FILE_IDS',
...
def test_resolve_cnv_normals_panel_returns_list_basename_and_all_ids(monkeypatch):
    ...
    monkeypatch.setattr(
        'dragen_align_pa.constants.constants.ICA_PON_FILE_IDS',
        {
            'panel-a': {
